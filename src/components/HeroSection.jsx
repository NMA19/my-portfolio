              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="grid grid-cols-2 gap-6">
                  ...
                  {[
                    ...
                    { name: "JS", color: "from-yellow-400 to-orange-500", delay: 0.5 },
                    { name: "Tailwind", color: "from-teal-400 to-cyan-500", delay: 1 },
                    { name: "HTML5", color: "from-orange-500 to-red-500", delay: 1.5 }
                  ].map((tech) => (
                    <motion.div
                      key={tech.name}
                      className={`w-24 h-24 bg-gradient-to-br ${tech.color} rounded-2xl flex items-center justify-center shadow-lg`}
